    ...
    <>
      ...
      <div className="pt-10 pb-20">
        ...
        <div className=" w-3/4 m-auto text-center py-5">
          We specialize in providing expert website design, development, and custom software solutions for small businesses, including professional websites, landing pages, online stores, booking systems, internal tools, and more—delivering fast, reliable, and easy-to-use solutions that help your business grow and run smoothly.
        </div>
        ...
        <div className="pt-10 px-5 text-center">
          <div className="text-xl text-primaryText">
            See more details about our services <Link to="/services"><span className="group hover:bg-highlight hover:text-highlightText pb-1">
                here
